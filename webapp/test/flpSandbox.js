		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comempempproject6-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comempempproject6-display": {
								"semanticObject": "comempempproject6",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.emp.empproject6",
									"url": sap.ui.require.toUrl("com/emp/empproject6")
								}
							}
						}
					}
